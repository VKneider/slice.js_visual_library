// Este componente se renderiza DENTRO del MultiRoute cuando la ruta es /components
export default class ComponentsHome extends HTMLElement {
   constructor(props) {
      super();
   ...
   async createQuickLinks() {
      ...
      const browseButton = await slice.build('Button', {
         ...
         onClickCallback: () => slice.router.navigate('/library/input/button'),
         customColor: {
...
customElements.define('slice-components-home', ComponentsHome);