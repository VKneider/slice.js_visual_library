  ...
  async init() {
    ...
    if (true) {
    ...
    }
      {
         ...
         if (container) {
            const lines = ["| Prop | Type | Required | Default | Allowed values |","| --- | --- | --- | --- | --- |","| `activeTab` | `string` | `false` | `` | - |","| `items[].id` | `string` | `true` | - | - |","| `items[].label` | `string` | `true` | - | - |","| `onTabChange` | `function` | `false` | `null` | - |"];
            const clean = (line) => {
               let value = line.trim();
               if (value.startsWith('|')) {
                  value = value.slice(1);
